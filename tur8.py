...
def getvalues():
    ...
    print(f"{namevalue.get(), Phonevalue.get(), gendervalue.get(), emengencyvalue.get(), paymentmodevalue.get(), foodservicevalue.get()}")
    with open("records.txt","a") as f:
        f.write(f"{namevalue.get(), Phonevalue.get(), gendervalue.get(), emengencyvalue.get(), paymentmodevalue.get(), foodservicevalue.get()}")
